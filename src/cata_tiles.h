...
void calculateStepAndSideDist(double rayDirZ, int& stepZ, double& sideDistZ, int mapZ, double deltaDistZ);

void witchSideCross(double& sideDistX, double& sideDistY, double& sideDistZ, double deltaDistX, int& mapX, int stepX, int& side, double deltaDistY, int& mapY, int stepY, double deltaDistZ, int& mapZ, int stepZ);
